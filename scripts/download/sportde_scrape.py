...
save_path = Path('../../data/sportde/serie_a/raw')
...
start_link = 'https://www.sport.de/fussball/italien-serie-a/se9033/2012-2013/ergebnisse-und-tabelle/'
...
def process_season(info):
	...
	save_season(standings, matchdays, games, 'serie_a', save_path)
