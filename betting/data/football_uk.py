...
__all__ = ['FOOTBALL_DATA_LINK', 'FOOTBALL_DATA_SEASONS', 'FOOTBALL_DATA_LEAGUE_CODES', 'FOOTBALL_DATA_LEAGUE_NAMES',
           'League', 'FOOTBALL_DATA_LEAGUES', 'build_full_link']
...
FOOTBALL_DATA_LEAGUES = [League(name=name, code=code) for name,code in zip(FOOTBALL_DATA_LEAGUE_NAMES, FOOTBALL_DATA_LEAGUE_CODES)]
